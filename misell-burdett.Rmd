...
values of $S_{P}(V0,\alpha)$. These values do not cover all the voltages
and aperture half angles of interest. We noticed that a plot of
ln(SP) vs. ln(V0) is linear, as shown below.
...
df.ln <- data.frame(ln.E0.eV=log(1000*df[,1]),
